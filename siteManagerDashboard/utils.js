...
export const pdfCoordinatesMap = {
  'consent': {
    'HP': {
      'V0.02': [{x: 100, y: 420}, {x0: 100, y0: 380}, {x1: 110, y1: 345}],
      'V1.0': [{x: 110, y: 420}, {x0: 110, y0: 380}, {x1: 110, y1: 340}]
    },
    'HFHS': {
      'V0.02': [{x: 110, y: 380}, {x0: 110, y0: 340}, {x1: 110, y1: 302}],
      'V1.0': [{x: 110, y: 380}, {x0: 110, y0: 340}, {x1: 110, y1: 302}]
    },
    'KPCO': {
      'V0.02': [{x: 110, y: 395}, {x0: 110, y0: 355}, {x1: 110, y1: 315}],
      'V1.0': [{x: 110, y: 395}, {x0: 110, y0: 355}, {x1: 110, y1: 315}]
    },
    'KPGA': {
      'V0.02': [{x: 110, y: 395}, {x0: 110, y0: 355}, {x1: 110, y1: 315}],
      'V1.0': [{x: 110, y: 395}, {x0: 110, y0: 355}, {x1: 110, y1: 315}]
    ...
    'KPHI': {
      'V0.02': [{x: 100, y: 365}, {x0: 100, y0: 325}, {x1: 110, y1: 286}],
      'V1.0': [{x: 110, y: 365}, {x0: 110, y0: 325}, {x1: 110, y1: 285}]
    },
    'KPNW': {
      'V0.02': [{x: 110, y: 390}, {x0: 110, y0: 350}, {x1: 110, y1: 312}],
      'V1.0': [{x: 110, y: 385}, {x0: 110, y0: 345}, {x1: 110, y1: 305}]
    },
    'MFC': {
      'V0.02': [{x: 110, y: 420}, {x0: 110, y0: 380}, {x1: 110, y1: 340}],
      'V1.0': [{x: 110, y: 420}, {x0: 110, y0: 380}, {x1: 110, y1: 340}]
    },
    'Sanford': {
      'V0.02': [{x: 105, y: 405}, {x0: 105, y0: 365}, {x1: 110, y1: 325}],
      'V1.0': [{x: 110, y: 400}, {x0: 110, y0: 360}, {x1: 110, y1: 330}]
    },
    'UCM': {
      'V0.02': [ {x: 110, y: 380} , {x0: 110, y0: 340} , {x1: 110, y1: 302} ],
      'V0.04': [ {x: 110, y: 380} , {x0: 110, y0: 340} , {x1: 115, y1: 300} ],
      'V1.0': [{x: 110, y: 380} , {x0: 110, y0: 340} , {x1: 110, y1: 302}]
    },
    'default': {
  ...
  'hipaa': {
    'HP': {
      'V0.02': [{x: 100, y: 415}, {x0: 80, y0: 370}, {x1: 100, y1: 464}],
      'V1.0': [{x: 100, y: 415}, {x0: 100, y0: 370}, {x1: 100, y1: 465}]
    },
    'HFHS': {
      'V0.02': [{x: 100, y: 425}, {x0: 80, y0: 385}, {x1: 100, y1: 465}],
      'V1.0': [{x: 100, y: 440}, {x0: 100, y0: 400}, {x1: 100, y1: 480}]
    },
    'KPCO': {
      'V0.02': [{x: 100, y: 408}, {x0: 80, y0: 370}, {x1: 100, y1: 450}],
      'V1.0': [{x: 100, y: 410}, {x0: 100, y0: 370}, {x1: 100, y1: 450}]
    },
    'KPGA': {
      'V0.02': [{x: 100, y: 345}, {x0: 80, y0: 305}, {x1: 100, y1: 385}],
      'V1.0': [{x: 100, y: 340}, {x0: 100, y0: 300}, {x1: 100, y1: 380}]
    },
    'KPHI': {
      'V0.02': [{x: 100, y: 410}, {x0: 80, y0: 370}, {x1: 100, y1: 450}],
    ...
    'MFC': {
      'V0.02': [{x: 100, y: 425}, {x0: 80, y0: 385}, {x1: 100, y1: 465}],
      'V1.0': [{x: 100, y: 425}, {x0: 100, y0: 380}, {x1: 100, y1: 465}]
    },
    'Sanford': {
      'V0.02': [{x: 100, y: 412}, {x0: 80, y0: 372}, {x1: 100, y1: 452}],
      'V1.0': [{x: 100, y: 410}, {x0: 100, y0: 370}, {x1: 100, y1: 452}]
    },
    'UCM': {
      'V0.02': [{x: 100, y: 424}, {x0: 80, y0: 384}, {x1: 100, y1: 464}],
