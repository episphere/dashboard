    ...
    (
        ( participantModule[fieldMapping.bloodFlag] === (fieldMapping.yes)) ?
            template += `
                    ...
                    participantModule[fieldMapping.biospecimenCollectionDetail] && humanReadableMDY(participantModule[fieldMapping.biospecimenCollectionDetail][fieldMapping.biospecimenFollowUp][fieldMapping.bloodDateTime]), biospecimenStatus(participantModule, fieldMapping.biosepcimenBloodCollection), "N", "N/A")}`
            : (
                template += `
                    ${getTemplateRow("fa fa-times fa-2x", "color: red", "Baseline", "Sample", "Blood", "Not Collected", "N/A", "N/A", "N", "N/A")}`
            )
    ...
    (
        ( participantModule[fieldMapping.urineFlag] === (fieldMapping.yes)) ?
            template += `
                ...
                participantModule[fieldMapping.biospecimenCollectionDetail] && humanReadableMDY(participantModule[fieldMapping.biospecimenCollectionDetail][fieldMapping.biospecimenFollowUp][fieldMapping.urineDateTime]), biospecimenStatus(participantModule, fieldMapping.biosepcimenUrineCollection), "N", "N/A")}`
            : (
                template += `
                        ${getTemplateRow("fa fa-times fa-2x", "color: red", "Baseline", "Sample", "Urine", "Not Collected", "N/A", "N/A", "N", "N/A")}`
            )
...
export const baselineMouthwashSample = (participantModule) => {
    ...
    (
        ( participantModule[fieldMapping.mouthwash] === (fieldMapping.yes)) ?
            ...
            participantModule[fieldMapping.biospecimenCollectionDetail] && humanReadableMDY(participantModule[fieldMapping.biospecimenCollectionDetail][fieldMapping.biospecimenFollowUp][fieldMapping.mouthwashDateTime]), biospecimenStatus(participantModule, fieldMapping.biosepcimenMouthwashdCollection), "N", "N/A")}`
            : (
                template += `
                        ${getTemplateRow("fa fa-times fa-2x", "color: red", "Baseline", "Sample", "Mouthwash", "Not Collected", "N/A", "N/A", "N", "N/A")}`
            )
...
const biospecimenStatus = (biospecimenRow, biospecimenFlag) => {
    let template = ``;
    !(biospecimenRow[fieldMapping.biospecimenCollectionDetail] && biospecimenRow[fieldMapping.biospecimenCollectionDetail][fieldMapping.biospecimenFollowUp]) ?  
    (
        template += `N/A`
    ) : 
    (
