...
recruit.ui=function(div){ // build user interface if 
    ...
    if(recruit.div){ // if a target div exists, build
        ...
        <p style="color:gray">Use something with the form <a href="https://episphere.github.io/dashboard/recruitParticipant/?site={siteNumId}&token={participantToken}" target="_blank">https://episphere.github.io/dashboard/recruitParticipant/?site={siteNumId}&token={participantToken}</a> for an example of a tokenized trajectory.</p>
        <div id="recruitDash">
        ...
        </div>
        `
